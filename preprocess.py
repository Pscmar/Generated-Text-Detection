...
### ↓↓↓ need to be modified when you change the dataset ↓↓↓ 
    ...
    # ### For short-sentence data ###
    # input_file = "./dataset/short.jsonl"
    # merged_file = "./dataset/short_merged.jsonl"
    # train_file = "./dataset/short_train.json"
    # val_file = "./dataset/short_val.json"
    # test_file = "./dataset/short_test.json"
    # ### For mixed data ###
    # input_file = "./dataset/mixed.jsonl"
    # merged_file = "./dataset/mixed_merged.jsonl"
    # train_file = "./dataset/mixed_train.json"
    # val_file = "./dataset/mixed_val.json"
    # test_file = "./dataset/mixed_test.json"
