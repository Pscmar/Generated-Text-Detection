...
### ↓↓↓ need to be modified when you change the dataset ↓↓↓
                # torch.save(self.model.state_dict(), "best_model_bert.pt")
                torch.save(self.model.state_dict(), "best_model_bert_short.pt")
                # torch.save(self.model.state_dict(), "best_model_bert_mixed.pt")
...
### ↓↓↓ need to be modified when you change the dataset ↓↓↓        
        # self.model.load_state_dict(torch.load("best_model_bert.pt"))
        self.model.load_state_dict(torch.load("best_model_bert_short.pt"))
        # self.model.load_state_dict(torch.load("best_model_bert_mixed.pt"))
